        ...
        public Response FunctionHandler(string request, Context context)
        {
            ...
            try
            {
                ...
                var commands = new IChatCommandHandler[]
                {
                    ...
                    new AcceptPhotoCommandHandler(presenter, botDataRepository, detailsRepo, photoRepo, settings.ModeratorsChatId),
                    new RejectPhotoCommandHandler(presenter, botDataRepository, photoRepo, settings.ModeratorsChatId, detailsRepo),
